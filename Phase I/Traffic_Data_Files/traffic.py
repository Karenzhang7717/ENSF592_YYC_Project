...
def extract_accidents(filename, year):
    """
    Extract traffic accident data from file for a given year and return a collection of dictionaries
    :param filename: name of data file
...
def main():
    ...
    accident_2017 = extract_accidents('Traffic_Incidents.csv', "2017")
    collection5 = database5['Accident2017']
    collection5.insert_many(accident_2017)
    
    # database6 = client['CalgaryTrafficAccident2018']
    # accident_2018 = extract_accidents('Traffic_Incidents.csv', "2018")
